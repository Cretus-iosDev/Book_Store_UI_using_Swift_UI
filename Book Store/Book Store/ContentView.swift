...
//  Book Store
//
//  Created by rutik maraskolhe on 04/07/21.
//
...
var furnitures = [
    [
    Furniture(id: 0, image: "r11", title: "", price: "$12"),
    Furniture(id: 1, image: "r12", title: "", price: "$6")
    ],
    
    [
    Furniture(id: 2, image: "r21", title: "", price: "$24"),
